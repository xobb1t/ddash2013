...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_activation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activations', to=orm['accounts.User'])),
        ...
        db.send_create_signal(u'accounts', ['Activation'])


    def backwards(self, orm):
        # Deleting model 'Activation'
        db.delete_table(u'accounts_activation')
    ...
    models = {
        u'accounts.activation': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activations'", 'to': u"orm['accounts.User']"})
        },
        u'accounts.user': {
